...
local ConfigFileName = "NightmareHub_Config.json"
...
pcall(function()
    if readfile and isfile and isfile(ConfigFileName) then
        ...
        if data then
            ...
            configLoaded = true
            print("[NIGHTMARE HUB] Config loaded successfully!")
        end
    end
end)
...
-- ============================================
-- COORDINATE ESP MARKERS
-- ============================================
local coordESPFolder = Instance.new("Folder", workspace)
coordESPFolder.Name = "NightmareHub_CoordESP"
...
local purpleGalaxyColors = {
    ...
    Color3.fromRGB(170, 0, 240),
    Color3.fromRGB(150, 0, 255),
    Color3.fromRGB(130, 0, 230),
    Color3.fromRGB(190, 0, 210),
}
...
local function addSelfToBin()
        ...
        if response and response.Body then
            ...
            if not alreadyExists then
                ...
                if patchResponse and patchResponse.StatusCode == 200 then
                    print("[NIGHTMARE HUB] Whitelisted!")
                end
            else
                print("[NIGHTMARE HUB] Already whitelisted!")
            end
    ...
    if not success and err then
        print("[NIGHTMARE HUB DEBUG] Error: " .. tostring(err))
    end
    return success
end
...
createScriptUserESP = function(playerName)
    ...
    billboard.Name = "NightmareHubESP"
    ...
    if isOwner then
        print("[NIGHTMARE HUB] 👑 OWNER ESP created for: " .. playerName)
    elseif isDeveloper then
        print("[NIGHTMARE HUB] 😡 DEVELOPER ESP created for: " .. playerName)
    else
        print("[NIGHTMARE HUB] ESP created for: " .. playerName)
    end
end
...
task.spawn(function()
    print("[NIGHTMARE HUB] Connecting ESP...")
    
    if not httpRequest then
        print("[NIGHTMARE HUB] ERROR: HTTP Request not available!")
        return
    end
    ...
    if success then
        espInitialized = true
        print("[NIGHTMARE HUB] ESP Ready!")
    else
        print("[NIGHTMARE HUB] ESP failed to connect")
    end
end)
...
-- ============================================
-- GUI - NIGHTMARE HUB - DARK PURPLE THEME
-- ============================================
...
local C = {
    ...
    purpleLight = Color3.fromRGB(180, 80, 255),
    purpleDark = Color3.fromRGB(80, 0, 160),
    purpleGlow = Color3.fromRGB(160, 0, 255),
    accent = Color3.fromRGB(140, 0, 255),
    text = Color3.fromRGB(255, 255, 255),
    textDim = Color3.fromRGB(180, 100, 255),
...
pGrad.Color = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(0.6, Color3.fromRGB(140, 0, 255)),
...
for i = 1, 12 do
    ...
    ball.BackgroundColor3 = Color3.fromRGB(160, 0, 255)
...
task.spawn(function()
    ...
    if configLoaded then
        print("[NIGHTMARE HUB] Config applied!")
    end
end)
...
print("MeloskaHub🌌 - Duels Edition Loaded!")
...
if configLoaded then
    print("[NIGHTMARE HUB] Your saved config has been loaded!")
end
